  ...
  return (
    <div className="bg-white py-12 ">
      ...
      <div className="bg-green-600 text-white py-10 mt-10 text-center">
          ...
          <p className="max-w-2xl mx-auto mb-6">Senden Sie uns Ihre unverbindliche Anfrage für einen erholsamen Campingurlaub auf der Erleninsel und wir werden uns mit den besten Angeboten bei Ihnen melden!</p>
